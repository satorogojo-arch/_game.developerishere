...
public class Third
{
    ...
    public static void Main()
    {
        ...
        // Prompting the user to input the second number to addition
        Console.Write("Input the second number to addition: ");
        // Reading the second number entered by the user and converting it to an integer
        num2 = Convert.ToInt32(Console.ReadLine());

        // Prompting the user to input the third number to subtraction
        Console.Write("Input the third number to subtraction: ");
